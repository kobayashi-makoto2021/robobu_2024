...
- [ ] Osoyoo UNO Board（ Arduino UNO rev.3と完全互換）x 1![](image\IMG_1536.JPG)

- [ ] USBケーブルx 1![](image\IMG_1535.JPG)
...
![ダウンロードページ](image/IDE_install%20(4).png)

![保存をクリック](image/save.png)

![ダウンロードしたファイルを実行](image/download.png)
...
![新しいスケッチを作成](image/create_new_sketch00.png)
...
このようにプログラムのコードの中でコメントを入れて説明を書きこんでおくと、後で見返したりほかの人に使ってもらう時に便利ですね。コメントは日本語でも構いませんが、できれば英語を使えるようになると良いです。わからない言語がある時は[Google翻訳](https://translate.google.com/?sl=en&tl=ja&op=translate&hl=ja)などを活用しましょう。

### 便利なコメントの使い方
他にもいろいろ便利は使い方があります。いかにコメントの使い方をまとめておきます。
...
次にスケッチをArduinに書き込んでいきます。まずUSBケーブルをArduinoとつなぎます。![](image\IMG_1534.JPG)
...
![ポートのセッティング](image/create_new_sketch02.png)

ないときはさらにこの画面

![ポートのセッティング](image/create_new_sketch03.png)

これでボードとポートのセッティングは終わりました。この作業は初めの一回だけ行えば大丈夫です。
